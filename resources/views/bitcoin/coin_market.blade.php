            ...
            <nav class="navbar">
              ...
              <div class="collapse navbar-collapse" id="menu-collapse">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="active"><a href="{{url('/coin_market')}}">Coins & Markets</a></li>
            ...
            <div class="icon-table">
              <div class="row">
                <div class="col-md-4 left">
                  <div class="icon-box">
                    <img src="{{url('bitcoin/images/bitcoin2.png')}}" alt="">
                    <h3>BTC</h3>
                    <span>1BTC = $ <span id='bt_buy'><?php $number = $buy['USD']['buy']; echo round($number,2); ?></span></span>
                  </div>
                </div>
                <div class="col-md-4 middle">
                  <div class="icon-box">
                    <img src="{{url('bitcoin/images/eth2.png')}}" alt="">
                    <h3>ETH</h3>
                    <span>1ETH= $ <span id='et_buy'><?php $number = $sell['ask']; echo round($number,2); ?></span></span>
                  </div>
                </div>
                <div class="col-md-4 right">
                  <div class="icon-box">
                    <img src="{{url('bitcoin/images/erc2.png')}}" alt="">
                    <h3>ERC20</h3>
                    <span>1ERC20 = <i class="fa fa-btc"> </i> <span id='bt_buy'><?php echo  $number = 1/$buy['USD']['buy'];  round($number,7); ?></span></span>
                  </div>
                </div>
              </div>
            </div>
